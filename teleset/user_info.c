...
void load_data(char fname[200],setdata *set)
{
  ...
  FILE *fp2 = fopen("/home/raj/Desktop/In_house_CMS/Ant_sel/Results", "w"); //opens up a file called "Results"
                                                           // and allows writing//
   ...
   while( ( ch = fgetc(fp) ) != EOF )
    {
     if(ch =='#')
      ...
      fclose(fp2);
      FILE *f3 = fopen("/home/raj/Desktop/In_house_CMS/Ant_sel/Results", "r");    
...
void file_input(setdata *set)
{
       char path[200], basename[200], input_fname[200]; 
        ...
        sprintf(path, "/home/raj/Desktop/In_house_CMS/teleset"); //Change pathway as needed //
